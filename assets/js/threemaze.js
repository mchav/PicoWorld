(function(window)
{
    ...
    function ThreeMaze(wrapper, button)
    {
        ...
        this.end = {};
        this.textures = {
            spaceTexture : new THREE.TextureLoader('/assets/img/space-background.jpg' )
        };
        this.side = 31;
        this.thickness = 20;
    ...
    ThreeMaze.prototype.onGenerateMaze = function()
    {
        ...
        this.map = new_map;
        this.player.visted = player_visited;
    ...
    ThreeMaze.prototype.initScene = function()
    {
        ...
        this.materials =
        {
            grey: new THREE.MeshLambertMaterial({color: 0x2194ce, wireframe: false, fog: true, emissive: 0x000000}),
            red: new THREE.MeshLambertMaterial({color: 0xf18260, ambient: 0xf18260, lineWidth: 1}),
            bump_wall: new THREE.MeshBasicMaterial( { map: new THREE.TextureLoader('assets/img/bump-wall-texture.jpg'), transparent: true } ),
            stone_texture: new THREE.TextureLoader('assets/img/stone_texture.jpg'),
            grass_texture: new THREE.TextureLoader('assets/img/grass_texture.jpg'),
            concrete_texture: new THREE.TextureLoader('assets/img/concrete_texture.jpg')                        
        };
    ...
    ThreeMaze.prototype.onKeyDown = function(evt)
    {
        ...
        {
            /*if (this.player.visited[x + direction.x][z + direction.z] === false) {
                this.player.visited[x + direction.x][z + direction.z] = true;
                this.num_visited += 1;
            }*/
    ...
    {
        var width = 500; //window.innerWidth || window.document.body.clientWidth;
        var height = 500; //window.innerHeight || window.document.body.clientHeight;
